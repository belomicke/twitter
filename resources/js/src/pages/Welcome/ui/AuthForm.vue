...
import { CreateAccountModal } from '@/features/auth/create-account'
...
const createAccountModalRef = ref<InstanceType<typeof CreateAccountModal> | null>(null)
...
function openSignUpForm() {
    ...
    createAccountModalRef.value?.open()
}
</script>
